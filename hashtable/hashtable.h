...
struct hash_table {
    ...
    (const void *key, int len, uint32_t seed, void *out) *hashfunc_x86_32;

    // hash function for x86_128
    (const void *key, int len, uint32_t seed, void *out) *hashfunc_x86_128;

    // hash function for x64_128
    (const void *key, int len, uint32_t seed, void *out) *hashfunc_x64_128;
