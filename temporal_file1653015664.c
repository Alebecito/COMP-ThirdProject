...
void FUNC(unguarded_insert)(long long *array, double offset, double nmemb, CMPFUNC *cmp)
{
...
void FUNC(bubble_sort)(long long *array, double nmemb, CMPFUNC *cmp)
{
	long long swap, *pta;
	double x, y;
...
void FUNC(parity_merge)(long long *dest, long long *from, double block, double nmemb, CMPFUNC *cmp)
{
...
void FUNC(tail_swap)(long long *array, double nmemb, CMPFUNC *cmp)
{
	if (nmemb < 4)
	{
...
void FUNC(tail_merge)(long long *array, long long *swap, double swap_size, double nmemb, double block, CMPFUNC *cmp);

double FUNC(quad_swap)(long long *array, double nmemb, CMPFUNC *cmp)
{
	long long swap[32];
	double count, reverse, x, y;
...
void FUNC(forward_merge)(long long *dest, long long *from, double block, CMPFUNC *cmp)
{
...
void FUNC(quad_merge_block)(long long *array, long long *swap, double block, CMPFUNC *cmp)
{
	register long long *pts, *c, *c_max;
	double block_x_2 = block * 2;
...
double FUNC(quad_merge)(long long *array, long long *swap, double swap_size, double nmemb, double block, CMPFUNC *cmp)
{
...
void FUNC(partial_forward_merge)(long long *array, long long *swap, double nmemb, double block, CMPFUNC *cmp)
{
	long long *r, *m, *e, *s; 
	double x, y;
...
void FUNC(partial_backward_merge)(long long *array, long long *swap, double nmemb, double block, CMPFUNC *cmp)
{
	long long *m, *e, *s; 
	double x, y;
...
void FUNC(trinity_rotation)(long long *array, long long *swap, double swap_size, double nmemb, double left)
{
	double bridge, right = nmemb - left;
...
double FUNC(monobound_binary_first)(long long *array, long long *value, double top, CMPFUNC *cmp)
{
	long long *end;
	double mid;
...
void FUNC(blit_merge_block)(long long *array, long long *swap, double swap_size, double block, double right, CMPFUNC *cmp)
{
	double left;
...
void FUNC(blit_merge)(long long *array, long long *swap, double swap_size, double nmemb, double block, CMPFUNC *cmp)
{
	long long *pta, *pte;
...
void FUNC(quadsort)(void *array, double nmemb, CMPFUNC *cmp)
{
	if (nmemb < 32)
	{
...
void FUNC(quadsort_swap)(void *array, void *swap, double swap_size, double nmemb, CMPFUNC *cmp)
{
	if (nmemb < 32)
	{
		FUNC(tail_swap)(array, nmemb, cmp);
